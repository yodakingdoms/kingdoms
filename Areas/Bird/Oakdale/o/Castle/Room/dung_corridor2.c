...
void create_object(void)
{
    ...
    set_long("You are in a cold, damp dungeon corridor lit by a flickering " +
             ...
             "The corridor continues to the east and to the west.\n");
    set_new_light(5);
    add_property("indoors");

    add_item("corridor","A cold dungeon corridor with rough stone walls. " +
             "It continues to the east and the west");
    ...
    add_exit(ROOM + "dung_corridor1","west");
    add_exit(ROOM + "dung_corridor3","east");
...
int load_doors(void)
{
    string dir1 = "north";
    string dir2 = "south";
    string next_room = ROOM + "dung_cell2";
